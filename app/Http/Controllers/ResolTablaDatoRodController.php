...
class ResolTablaDatoRodController extends Controller
{
    public function index()
    {
        $datos = ResolTableDato::all();
        return view('resol_tabla_dato_rod.index', ['datos' => $datos]);
    }

    public function create()
    {
        return view('resol_tabla_dato_rod.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('resol_tabla_dato_rod.index');
    }

    public function show(ResolTableDato $dato)
    {
        return view('resol_tabla_dato_rod.show', ['dato' => $dato]);
    }

    public function edit(ResolTableDato $resolTableDatoSim, $id)
    {
        $dato = ResolTableDato::find($id);
        return view('resol_tabla_dato_rod.edit', ['dato' => $dato]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('resol_tabla_dato_rod.index')->with('status', 'Dato actualizado con éxito');
    }
